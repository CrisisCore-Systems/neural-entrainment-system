...
describe('AudioEngine', () => {
  ...
  describe('Frequency Validation', () => {
    ...
    it('should reject frequencies below 20Hz', () => {
      expect(() => audioEngine.setFrequency(10)).toThrow('Frequency must be between 20Hz and 20kHz');
    });
    
    it('should reject frequencies above 20kHz', () => {
      expect(() => audioEngine.setFrequency(25000)).toThrow('Frequency must be between 20Hz and 20kHz');
    });
