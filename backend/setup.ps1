...
Write-Host "✅ .env created with CORS_ORIGIN=$CorsOrigins" -ForegroundColor Green
Write-Host "▶️  To start the backend in dev: cd $PSScriptRoot; npm install; npm run dev" -ForegroundColor Yellow
